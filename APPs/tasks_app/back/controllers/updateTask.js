...
exports.updateCompletedTask = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({msg: 'Update Completed Status Fail' + error})
    }
}
...
exports.updateTask = async (req, res) => {
    ...
    try {
        await database.query('UPDATE tasks SET title = $1, description = $2, date = $3, isCompleted = $4, isImportant = $5 WHERE _id = $6',
